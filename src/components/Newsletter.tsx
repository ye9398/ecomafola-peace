...
export default function Newsletter() {
  ...
  return (
    <section className="py-20 bg-[#4A7C59] relative overflow-hidden">
      {/* Decorative Border */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#7FB895]/40 to-transparent" />
      <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#7FB895]/40 to-transparent" />
