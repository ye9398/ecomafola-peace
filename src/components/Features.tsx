const features = [
  {
    ...
    image: '/images/feature-eco-friendly.jpg',
  },
  {
  ...
  },
  {
    ...
    image: '/images/feature-ocean.jpg',
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="relative overflow-hidden rounded-lg shadow-md group w-full"
            >
              ...
              <div className="relative z-10 p-8 text-white">
                <h3 className="font-serif text-2xl font-semibold mb-3 drop-shadow-md text-sand-beige">
                  {feature.title}
                </h3>
                <p className="font-sans text-base leading-relaxed drop-shadow-sm text-sand-beige">
                  {feature.description}
                </p>
              </div>
            </div>
