const stats = [
  { 
    ...
    bgImage: '/images/impact/artisan-partners.webp'
  },
  { 
    value: '5', 
    label: 'Village Cooperatives',
    bgImage: '/images/impact/village-cooperatives.webp'
  },
  { 
    value: '1%', 
    label: 'Back to Community',
    bgImage: '/images/impact/back-to-community.webp'
  },
  { 
    value: '12', 
    label: 'Countries Served',
    bgImage: '/images/impact/countries-served.webp'
  },
]
...
export default function Impact() {
  return (
    <section className="py-20 bg-gradient-to-br from-tropical-green to-ocean-blue relative overflow-hidden">
      {/* Decorative Circles */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="text-center p-6 bg-white/10 backdrop-blur-sm border border-white/20 shadow-lg relative overflow-hidden rounded-lg"
            >
              ...
              <div className="absolute inset-0 bg-ocean-blue/75 z-[1]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {stories.map((story) => (
            <div key={story.name} className="bg-white/10 backdrop-blur-sm border border-white/20 p-8 shadow-lg relative">
              {/* Quote Icon */}
